🤖 JARVIS-2025 — AI Personal Assistant (Advanced Final Year Project)
...
Voice Commands
Command	Result
"Jarvis open Chrome"	Opens browser
"Play music"	Plays your music folder
"What is AI?"	LLM explanation
"Send WhatsApp message to Rahul"	Automated message
"What’s the weather?"	API-based weather
📘 API Documentation (Internal Functions)
Example:
...
Model not responding	Wrong OpenAI key	Add valid key
“No module found”	Virtual environment not activated	envJarvis\Scripts\activate
🚀 Roadmap
